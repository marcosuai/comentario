...
echo '<title>Confirmar Exclusão</title>';
echo '<link rel="stylesheet" href="estilo.css">'; // Usando o arquivo estilo.css
echo '</head>';
echo '<body>';
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo '<a class="botao-globo" href="excluir_aluno.php?id=' . $idAluno . '&confirmar=1"><span>Sim</span></a>'; // Link para confirmar
    echo ' | ';
    echo '<a class="botao-globo" href="index1.php"><span>Cancelar</span></a>'; // Link para voltar à consulta
} else {
...
if (isset($_GET["confirmar"]) && $_GET["confirmar"] == 1) {
    ...
    if ($resultDelete) {
        ...
        echo '<a class="botao-globo" href="index1.php"><span>Voltar à Consulta</span></a>';
    } else {
